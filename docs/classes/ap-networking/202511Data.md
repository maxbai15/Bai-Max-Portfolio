...
- OSI and TCP/IP layer mapping showing protocol alignment    
...
### Lab 6: Viewing IP in Hexadecimal
...
This is your IP address and it's how devices identify each other on a local network. Each VM will have a different IP address and need both to communicate.
...
After connecting, the two VM's can communicate with each other.
...
| MAC Address | `ip -o addr show` | Hardware address identified in hex format |
